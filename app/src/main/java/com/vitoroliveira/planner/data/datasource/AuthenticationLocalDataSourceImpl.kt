...
private const val ADICIONAL_EXPIRATION_DATETIME_MILLIS = 60_000 * 60
...
class AuthenticationLocalDataSourceImpl(
    ...
    override suspend fun insertToken(token: String) {
        applicationContext.authenticationPreferencesDataStore.edit { settings ->
            ...
            settings[EXPIRATION_DATETIME_PREFERENCES_KEY] = System.currentTimeMillis() + ADICIONAL_EXPIRATION_DATETIME_MILLIS
        }
    }
}